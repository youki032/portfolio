...
<head>
    ...
    <!-- Site Properties -->
    <title> - WriteFrom_TrashBox - </title>  
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/trashbox/stylesheets/trashbox-writeForm.css"/>">  
...
<script type="text/javascript">   
    ...
    // 업로드한 파일명을 input에 넣기위해 배열 변수안에 쌓아 넣는다.   
    var arrayImg = [];
           ...
           <div class="two column row">
               <div class="column" id="grid_column">
                  <h2 class="ui header" id="normal_header">
                     <i class="write icon"></i>${board.boardName}
                  </h2>
              </div>
           </div>
      </div>
...
<form name="writeForm" id="form" action="<c:url value='/article/addArticle'/>" method="post">
<table class="ui celled table" border="1">
<tr class="title_tr">
  <th>제목</th>
  <td>
    <div class="ui fluid input">
      <input name="title" id="title" type="text" maxlength="37"  placeholder="제목을 입력해주세요." min="3" />
    </div>
  </td>
</tr>
<tr class="nicname_tr">
...
<tr class="content_tr">
  <th colspan="2"><textarea name="content" id="content" rows="5" cols="50" >**HTML편집기로는 iframe만 적용하실수 있습니다.**<br/>${article.content}</textarea></th>
</tr>
<tr class="file_tr">
  <th>첨부된 파일</th>
    <td>
...
<input type="hidden" name="pageNo" value="${pageNo.pageNo}" />
...
<sec:csrfInput/>
 ...
 <div class="ui small modal" id="uploadModal">
  ...
  <div class="submit_btns">
      <input class="ui tiny green button" type="button" value="등록" onclick="do_submit('writeForm');"/>
